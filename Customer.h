...
public:
    ...
    Customer(const string& id, const string& name,
             const string& phoneNumber, const string& customerAddress,
    ...
    void save(ofstream& file) const {
        ...
        file.write(reinterpret_cast<const char*>(&accountCount),
                   sizeof(accountCount));
        ...
        file.write(reinterpret_cast<const char*>(&transactionCount),
